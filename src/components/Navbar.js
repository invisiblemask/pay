            ...
            <div className='relative lg:flex lg:flex-col'>
                ...
                <div className='flex justify-between p-4 lg:px-24'>
                    ...
                    <div className='hidden lg:flex lg:flex-row gap-4'>
                        <button className='border text-cyan-600 font-bold rounded-3xl px-4 py-2 text-sm'>Sign In</button>
                        <button className='border bg-cyan-600 text-gray-50 font-bold rounded-3xl px-4 py-2 text-sm'>Free trial</button>
                    </div>
                    <div
                ...
                <div className={showNav ? 'bg-white absolute right-0 top-0 shadow-xl h-screen z-50 w-3/4 lg:hidden' : 'hidden'}>
                    <div
