...
const Footer = () => {
    return (
        <div>
            <div className='bg-slate-900 text-white p-8 lg:pt-60'>
                <div className='lg:flex lg:flex-row lg:justify-between lg:px-32'>
                    <div className='font-bold text-2xl mb-4'>
                        <a href="/">Pay</a>
                    </div>
                    <div className='flex flex-col gap-4 mb-4 lg:flex-row lg:gap-36'>
                        <div>
